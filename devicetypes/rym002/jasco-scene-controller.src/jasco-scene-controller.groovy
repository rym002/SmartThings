...
metadata {
	definition (name: "Jasco Scene Controller", namespace: "rym002", author: "SmartThings", ocfDeviceType: "x.com.st.d.remotecontroller", mnmn: "SmartThings", vid: "generic-button-4") {
		capability "Button"
		capability "Sensor"
	}
}
