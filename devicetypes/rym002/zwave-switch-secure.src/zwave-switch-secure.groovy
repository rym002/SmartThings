 ...
 */
metadata {
	definition(name: "Z-Wave Switch Secure", namespace: "rym002", author: "Raymond Munian", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		capability "Switch"
		capability "Refresh"
		capability "Polling"
		capability "Actuator"
